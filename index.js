...
const GOOGLE_SCRIPT_URL_THAM_DU =
  "https://script.google.com/macros/s/AKfycbywjAlXr1xE0_BpfEYvws_fpkhsZFiqRVs7Ss_a0r56NsVVIW1Sk18HvRLMUhjR03v8/exec";
document
  ...
  .addEventListener("submit", function (e) {
    ...
    let selected_form_8 = formData.getAll("form_item13");
    let selected_form_12 = formData.getAll("form_item12");
    let selected_form_14 = formData.getAll("form_item14");

    const data = {
      name: "'" + form.name.value,
      attend: "'" + selected_form_6.join(", "), // Xác nhận tham dự
      guest: "'" + selected_form_8.join(", "), // Khách của ai
      attendParty: "'" + selected_form_14.join(", "), // Tham dự bữa tiệc nào?
      wishVisibility: "'" + selected_form_12.join(", "), // Ai sẽ thấy lời chúc của bạn?
      numGuests: "'" + form.form_item8.value, // Số lượng người tham dự
    ...
    document.getElementById("SECTION15").scrollIntoView({
      behavior: "smooth",
      block: "start",
    });
  });
